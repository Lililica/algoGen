...
public class Lsystem : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        list_trees = new List<GameObject>();
        once = true; 
        is_done = false;
    }

    // void make_tree_copie()
    // {
    //     if(is_done && once)
    //     {
    //         Debug.Log("copie done"+once);
    ...
    //         GameObject my_copie_2 = Instantiate(parent,copie.transform.position,Quaternion.identity);
    ...
    void Update()
    {
        ...
        g_o.L_system_maker = this.gameObject;
        g_o.copie_position = copie_position;
        }
