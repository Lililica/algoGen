...
public class FractalMaster : MonoBehaviour
{
    ...
    [Range (0, 100)] public int detail = 15;
    [Range(1, 100)] public float breakDistance = 2f;

    [Header("Spikiness Settings")]
    [Range(0, 10)] public float test1 = 1f;
    [Range(0, 2)] public float test2 = 0f;
    [Range(0, 2)] public float test3 = 1f;
    [Range(0, 2)] public float test4 = 1f;
    [Range(0, 10)] public float test5 = 1f;
    [Range(0, 10)] public float test6 = 1f;
    ...
    void SetParameters () {
        ...
        fractalShader.SetFloat("detail", detail);
        fractalShader.SetFloat("breakDistance", breakDistance);

        fractalShader.SetFloat("test1", test1);
        fractalShader.SetFloat("test2", test2);
        fractalShader.SetFloat("test3", test3);
        fractalShader.SetFloat("test4", test4);
        fractalShader.SetFloat("test5", test5);
        fractalShader.SetFloat("test6", test6);
